%% CS 231A PS3 Shape Context Problem 4 part a ii
close all;
clc
addpath('SupportCode')
...
for i = 1:length(mm_loop)
    ...
    while s
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        % THIS IS WHERE YOUR CODE FOR COMPUTE_SHAPE_CONTEXT WILL GO!%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %%%
    %%% windowed Sum of Squared Distances comparison
    %%%
    wd=2*w+1;
    win_fun=gaussker(wd);
    ...
    if display_flag
        ...
        set(h,'string',['Error=' num2str(ssd_local)])
    end
